...
from Customer_Churn.cloud_storage.aws_storage import SimpleStorageService
from Customer_Churn.exception import CustomerChurnException
from Customer_Churn.logger import logging
from Customer_Churn.entity.artifact_entity import ModelPusherArtifact, ModelEvaluationArtifact
from Customer_Churn.entity.config_entity import ModelPusherConfig
...
class ModelPusher:
    def __init__(self, model_evaluation_artifact: ModelEvaluationArtifact,
        ...
        self.usvisa_estimator = CustomerChurnEstimator(bucket_name=model_pusher_config.bucket_name,
